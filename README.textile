...
_(24 July, 2012)_
This library is no longer being maintained. I would be happy to hand over it's maintenance to someone else if they would like to continue the project, but I will not be making any updates.
...
class Openid_auth extends Controller {
